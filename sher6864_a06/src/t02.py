...
print("Testing secret_queue.split_key(5) with a secret queue that is a copy of queue 1 before split_alt. Splitting secret_queue to queue7 and queue8")
queue7, queue8 = secret_queue.split_key(5)
print(f"queue7: {queue7}")
print(f"queue8: {queue8}")
